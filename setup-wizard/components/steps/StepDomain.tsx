      ...
      {config.hasDomain ? (
        <div className="space-y-6">
          ...
          <div>
            ...
            <CodeBlock code={nginxExample} label="nginx config on your web server (not the validator VPS)" multiline />
            <p className="text-xs text-gray-500 mt-2">
              This goes on the <strong className="text-gray-300">web server hosting your domain</strong> (where you placed the TOML file) — not your validator VPS.
